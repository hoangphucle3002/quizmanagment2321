...
namespace Interface
{
    public partial class POINT : Form
    {
        ...
        QUESTION_BUL cauhoi_bul = new QUESTION_BUL();
        POINT_BUL phieudiem_bul = new POINT_BUL();
        ...
        private void PHIEUCHAMDIEM_Load(object sender, EventArgs e)
        {
            ...
            POINTp phieudiem_public = new  POINTp();
        ...
        private void bttinhdiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                POINTp inphieudiem_public = new POINTp();
                QUESTIONp cauhoi_public = new QUESTIONp();
                EXAMLISTp dsnopbai_public = new EXAMLISTp();
        ...
        private void txtsodiemtungcau_TextChanged(object sender, EventArgs e)
        {
